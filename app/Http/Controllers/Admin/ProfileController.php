...
class ProfileController extends BaseController
{
    ...
    public function updatePassword2(Request $request){
        ...
        return $this->adminService->getAdminPasswordData($request->pass);
        $this->adminRepo->update(id:$request->id,data:$this->adminService->getAdminPasswordData(request:$request));
        return "done";
    }
}
