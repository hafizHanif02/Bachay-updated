...
class ThemeService
{
    ...
    {
        $themeInfo = include('resources/themes/'.$request['theme'].'/public/addon/info.php');
        ...
        $currentThemeRoutes = include('resources/themes/'.$currentTheme.'/public/addon/theme_routes.php');
        ...
        if (is_file(base_path('resources/themes/'.$request['theme'].'/public/addon/theme_routes.php'))) {
            $themeRoutes = include('resources/themes/'.$request['theme'].'/public/addon/theme_routes.php');
            $reloadAction = 0;
