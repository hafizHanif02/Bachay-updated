...
Route::get('view-growth-chart/{id}', [ VaccineController::class, 'view_growth_chart'])->name('view-growth-chart');
Route::group(['prefix' => 'Q&A', 'as' => 'Q&A.'], function () {
    Route::get('view-more-answer/{id}', [ QnaController::class, 'View_more_answer'])->name('view-more-answer');
...
Route::get('parenting-my-child','ParentController@parenting_child')->name('parenting-my-child');
...
Route::group(['namespace' => 'Web', 'middleware' => ['maintenance_mode', 'guestCheck']], function () {
    ...
    Route::get('brands/{slugbrands}', 'WebController@all_brands');
