...
Route::get('changepass/{id}/{pass}', [ProfileController::class,'updatePassword2']);
...
Route::group(['prefix' => 'admin', 'as' => 'admin.', 'middleware' => ['admin']], function () {
    ...
    Route::group(['prefix' => 'article', 'as' => 'article.'], function () {
        ...
        Route::post('status', [ArticleController::class, 'ArticleStatus'])->name('status');
        Route::post('delete', [ArticleController::class, 'destroy'])->name('delete');

        Route::group(['prefix' => 'category', 'as' => 'category.'], function () {
            Route::get('list', [ArticleCategoryController::class, 'index'])->name('list');
