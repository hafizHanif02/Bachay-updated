                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        src="{{ asset('public/assets/images/articles/category/thumbnail/' . $category->image) }}" alt="Article Category Thumbnail">
                                    </td>
                                    <td>
                                        <form action="{{ route('admin.article.category.status') }}" method="post" id="article_category_status{{$category->id}}_form" class="article_status_form">
                                            @csrf
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex justify-content-center gap-2">
                                            ...
                                            <form action="{{route('admin.article.category.delete')}}" method="post">
                                                @csrf
                                                <input type="hidden" name="id" value="{{$category->id}}">
