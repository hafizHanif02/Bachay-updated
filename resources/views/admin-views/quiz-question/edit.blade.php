	...
	<div class="row gx-2 gx-lg-3">
		<div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
			<div class="card">
				<div class="card-body">
				  <div class="container">
					<form action="{{ route('admin.customer.quiz.question.update') }}" method="post" enctype="multipart/form-data">
						@csrf
									...
									<tr>
										<td>
											...
											<div class="col-md-10 mt-2">
												<label for="" class="form-label text-center">{{ $loop->iteration }}</label>
										...
										<td>
											...
											@endforeach
											<input type="input" name="correct_answer">
										</td>
									</tr>
								</tbody>
							</table>
								...
								<td>
									<div class="d-flex justify-content-center gap-2">
										<a class="btn btn-outline--primary btn-sm edit square-btn"
										    title="View Quiz"
										   href="{{ route('admin.customer.quiz.view', $quiz->id) }}">
										   <i class="tio-edit"></i>
										</a>
