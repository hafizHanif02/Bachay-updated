...
@section('title', translate('vaccination_submission'))
        ...
        <div class="row" id="printableArea">
            <div class="col-lg-8 mb-3 mb-lg-0">
                <div class="card">
                    ...
                    <form action="{{ route('admin.customer.parent.child.vaccine_submission.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="m-5">
                            ...
                            <div class="row mb-2 mt-2">
                                <div class="col-md-6">
                                    ...
                                    <input required type="text" step="any" name="head_circle" placeholder="Enter Head Circle" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label for="" class="col-form-label">Submission Date</label>
                                    <input required type="date" name="submission_date" placeholder="Enter Submission Date" class="form-control">
                                </div>
                            </div>
                            <div class="row mb-2 mt-2">
                                <div class="col-md-6">
                                    <label for="" class="col-form-label">Height</label>
                                    <input required type="text" step="any" name="height" placeholder="Enter Height" class="form-control">
                                </div>
                                <div class="col-md-6">
                                    <label for="" class="col-form-label">Weight</label>
                                    <input required type="text" step="any" name="weight" placeholder="Enter Weight" class="form-control">
                                </div>
                            </div>
