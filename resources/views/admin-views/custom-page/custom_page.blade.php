                        ...
                        <form action="{{route('admin.custom-page.store')}}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="file" name="image" class="form-control" id="title" placeholder="Enter title">
                                </div>
                        ...
                        <table id="columnSearchDatatable"
                            ...
                            @foreach($custom_pages as $custom_page)
                                ...
                                <tr id="data-{{$custom_page->id}}">
                                    ...
                                    <td>
                                        <form action="{{route('admin.custom-page.web',$custom_page['id'])}}" method="post" id="web_form{{$custom_page['id']}}" >
                                            @csrf
                                    ...
                                    <td>
                                        <form action="{{route('admin.custom-page.mobile',$custom_page['id'])}}" method="post" id="mobile_form{{$custom_page['id']}}" >
                                            @csrf
                                            <input type="hidden" name="id" value="{{$custom_page['id']}}">
                                            <label class="switcher">
                                    ...
                                    <td>
                                        <div class="d-flex gap-10 justify-content-center">
                                            <a class="btn btn-outline--primary btn-sm cursor-pointer edit"
                                               ...
                                               href="{{route('admin.custom-page.edit',$custom_page['id'])}}">
                                                <i class="tio-edit"></i>
                                            </a>
                                            {{-- {{ dd($custom_page->id) }} --}}
                                            <a class="btn btn-outline-danger btn-sm {{-- cursor-pointer delete --}}"
                                               title="{{ translate('delete')}}"
                                               href="{{route('admin.custom-page.delete',$custom_page['id'])}}">
