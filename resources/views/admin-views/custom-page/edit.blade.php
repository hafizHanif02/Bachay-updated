        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('admin.custom-page.image.store', $custom_page['id']) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                    <label for="image" class="form-label">Image</label>
                ...
                <div class="row mt-3">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="url" placeholder="Enter Url" class="form-control" id="url">
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-md-6">
                        <label for="width" class="form-label">Width</label>
                        <input type="number" step="any" name="width" placeholder="Enter Width" class="form-control" id="tags" value="20">
                    </div>
                    <div class="col-md-6">
                ...
                <tr id="data-{{$page_data->id}}">
                    ...
                    <td>
                        <div class="d-flex gap-10 justify-content-center">
                            ...
                            <a class="btn btn-outline-danger btn-sm " href="{{ route('admin.custom-page.page-data.delete', $page_data['id']) }}"
