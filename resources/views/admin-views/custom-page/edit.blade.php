                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.custom-page.update', $custom_page['id']) }}" method="post"
                            enctype="multipart/form-data" class="custom_page_form">
                            @csrf
                            <div class="row g-3">
                                <div class="col-md-6">
                                    <label for="title" class="form-label">Title</label>
                                    <input type="text" name="title" class="form-control"
                                        value="{{ $custom_page['title'] ?? '' }}" id="title" placeholder="Enter title">
                                </div>
                                <div class="col-md-6">
                                    <label for="image" class="form-label">Image</label>
                                    <input type="file" name="image" class="form-control"
                                        value="{{ $custom_page['image'] ?? '' }}" id="title" placeholder="Enter title">
                                </div>
                                <div class="form-group">
                                    ...
                                    <select onchange="display_data(this.value)"
                                        value="{{ $custom_page['resource_type'] ?? '' }}"
                                        class="js-example-responsive form-control w-100" name="resource_type" required>
                                        <option {{ $custom_page['resource_type'] == 'product' ? 'selected' : '' }}
                                            value="product">{{ translate('product') }}</option>
                                        <option {{ $custom_page['resource_type'] == 'category' ? 'selected' : '' }}
                                            value="category">{{ translate('category') }}</option>
                                        <option {{ $custom_page['sub_category'] == 'product' ? 'selected' : '' }}
                                            value="sub_category">{{ translate('sub_category') }}</option>
                                        <option {{ $custom_page['resource_type'] == 'shop' ? 'selected' : '' }}
                                            value="shop">{{ translate('shop') }}</option>
                                        <option {{ $custom_page['resource_type'] == 'brand' ? 'selected' : '' }}
                                            value="brand">{{ translate('brand') }}</option>
                                        <option {{ $custom_page['resource_type'] == 'deals' ? 'selected' : '' }}
                                            value="deals">{{ translate('deals') }}</option>
                                        <option {{ $custom_page['resource_type'] == 'none' ? 'selected' : '' }}
                                            value="none">{{ translate('none') }}</option>
                                    </select>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3 {{ $custom_page['resource_type'] == 'product' ? '' : 'd--none' }}"
                                        id="resource-product">
                                    ...
                                    <div class="form-group mb-3 {{ $custom_page['resource_type'] == 'deals' ? '' : 'd--none' }}"
                                        id="resource-deals">
                                        <label for="deals_id"
                                            class="title-color text-capitalize">{{ translate('deals') }}</label>
                                        <select class="js-example-responsive form-control w-100" name="deals_id">
                                            @foreach (\App\Models\FlashDeal::get() as $flashdeal)
                                                <option value="{{ $flashdeal['id'] }}">{{ $flashdeal['title'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>

                                    <div class="form-group mb-3 {{ $custom_page['resource_type'] == 'category' ? '' : 'd--none' }}"
                                    ...
                                    <div class="form-group mb-3 {{ $custom_page['resource_type'] == 'sub_category' ? '' : 'd--none' }}"
                                        id="resource-sub_category">
                                        <label for="name"
                                        ...
                                        <select class="js-example-responsive form-control w-100" name="sub_category_id">
                                            @foreach (\App\Models\Category::get() as $sub_category)
                                    ...
                                    <div class="form-group mb-3 {{ $custom_page['resource_type'] == 'shop' ? '' : 'd--none' }}"
                                        id="resource-shop">
                                    ...
                                    <div class="form-group mb-3 {{ $custom_page['resource_type'] == 'brand' ? '' : 'd--none' }}"
                                        id="resource-brand">
                                        <label for="brand_id"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('admin.custom-page.image.store', $custom_page['id']) }}" method="POST"
                        ...
                        <div class="row mt-3">
                            <div class="col-md-12">
                                <label for="tags" class="form-label">URL</label>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" step="any" name="width" placeholder="Enter Width"
                                    class="form-control" id="tags" value="20">
                            </div>
                            <div class="col-md-6">
                                <label for="margin_bottom" class="form-label">Margin Bottom</label>
                                <input type="number" name="margin_bottom" placeholder="Enter Margin Bottom"
                                    class="form-control" id="tags" value="0">
                            </div>
                        </div>
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <label for="margin_right" class="form-label">Margin Right</label>
                                <input type="number" name="margin_right" placeholder="Enter Margin Right"
                                    class="form-control" id="tags" value="0">
                            </div>
                        </div>
                </div>
            ...
            @foreach ($custom_page->page_data as $page_data)
                ...
                <tbody>
                    <tr id="data-{{ $page_data->id }}">
                        ...
                        <td><img width="{{ $page_data->width }}px" src="{{ $page_data->imageurl }}" alt="">
                        </td>
                        <td>{{ $page_data->url }}</td>
                        ...
                        <td>
                            <div class="d-flex gap-10 justify-content-center">
                               ...
                               href="{{route('admin.custom-page.page-data.edit',$page_data['id'])}}">
                                <i class="tio-edit"></i>
                            </a> --}}
                                ...
                                <button type="button" class="btn btn-outline-primary btn-sm " data-toggle="modal"
                                    data-target="#exampleModalEdit{{ $page_data['id'] }}">
                                    <i class="tio-edit"></i>
                                </button>
                                <a class="btn btn-outline-danger btn-sm "
                                    href="{{ route('admin.custom-page.page-data.delete', $page_data['id']) }}"
                                    title="{{ translate('delete') }}" id="{{ $custom_page['id'] }}">
                ...
                <div class="modal fade" id="exampleModalEdit{{ $page_data['id'] }}" tabindex="-1" aria-labelledby="exampleModalEdit" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Insert Image</h5>
                            ...
                            <div class="modal-body">
                                <form action="{{ route('admin.custom-page.image.edit', $custom_page['id']) }}" method="POST"
                                    enctype="multipart/form-data">
                                    @csrf
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <label for="tags" class="form-label">Tags</label>
                                            <input type="text" name="tags" value="{{ $page_data->tags }}" placeholder="Enter Tags" class="form-control"
                                                id="tags">
                                        </div>
                                    </div>
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-md-12">
                                            <label for="tags" class="form-label">URL</label>
                                            <input type="text" value="{{ $page_data->url }}" name="url" placeholder="Enter Url" class="form-control"
                                                id="url">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <label for="width" class="form-label">Width</label>
                                            <input type="number" step="any" name="width" placeholder="Enter Width"
                                                class="form-control" value="{{ $page_data->width }}" id="tags" value="20">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="margin_bottom" class="form-label">Margin Bottom</label>
                                            <input type="number" name="margin_bottom" placeholder="Enter Margin Bottom"
                                                class="form-control" value="{{ $page_data->margin_bottom }}" id="tags" value="0">
                                        </div>
                                    </div>
                                    <div class="row mt-3">
                                        <div class="col-md-6">
                                            <label for="margin_right" class="form-label">Margin Right</label>
                                            <input type="number" name="margin_right" placeholder="Enter Margin Right"
                                                class="form-control" value="{{ $page_data->margin_right }}" id="tags" value="0">
                                        </div>
                                    </div>
                            </div>
                            <div class="modal-footer">
    ...
    {{-- <div class="modal fade" id="exampleModalEdit" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{ route('admin.custom-page.page-data.update', $custom_page['id']) }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="col-md-12">
                    <label for="image" class="form-label">Image</label>
...
@push('script')
    ...
    <script>
        ...
        $('.cancel').on('click', function() {
            $('.custom_page_form').attr('action', "{{ route('admin.custom-page.store') }}");
