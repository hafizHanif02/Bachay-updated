...
<div class="content container-fluid">
	...
	<div class="row gx-2 gx-lg-3">
		<div class="col-sm-12 col-lg-12 mb-3 mb-lg-2">
			<div class="card">
				<div class="card-body">
					<form action="{{ route('admin.customer.vaccine.store') }}" method="post" enctype="multipart/form-data">
						@csrf
						<div class="row g-3">
							<div class="col-md-6">
							...
							<td class="text-center">
								<div class="d-flex justify-content-center gap-2">
									<a class="btn btn-outline--primary btn-sm edit square-btn"
									   ...
									   href="{{ route('admin.customer.vaccine.edit', $vaccine->id) }}">
										<i class="tio-edit"></i>
									</a>
									<form action="{{route('admin.customer.vaccine.delete')}}" method="post">
									@csrf
