                            ...
                            <div class="footer-address-card d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <a href="https://www.google.com/maps/place/{{ getWebConfig(name: 'shop_address') }}"
                                        target="_blank" class="text-dark">{{ getWebConfig(name: 'shop_address') }}
                                    </a>
                                </div>
                            </div>
                            <div class="footer-address-card d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <a class="text-dark"
                                        href="mailto:{{ $web_config['email']->value }}">{{ $web_config['email']->value }}</a>
                                </div>
                            </div>
                            <div class="footer-address-card d-flex gap-3">
                                ...
                                <div>
                                    ...
                                    <div><a href="tel:{{ $web_config['phone']->value }}"
                                            class="text-dark">{{ $web_config['phone']->value }}</a></div>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="footer-bottom-wrapper text-capitalize">
                                    ...
                                    <ul class="links">
                                        <li>
                                            @if (auth('customer')->check())
                                                <a
                                                    href="{{ route('user-profile') }}">{{ translate('profile_info') }}</a>
                                            @else
                                                <a href="javascript:"
                                                    class="customer_login_register_modal">{{ translate('profile_info') }}</a>
                                            @endif
                                        </li>
                                        <li>
                                            @if (auth('customer')->check())
                                            ...
                                            @else
                                                <a href="javascript:"
                                                    class="customer_login_register_modal">{{ translate('orders') }}</a>
                                            @endif
                                        </li>
                                        ...
                                        @if ($web_config['ref_earning_status'])
                                            <li>
                                                @if (auth('customer')->check())
                                                    <a
                                                        href="{{ route('refer-earn') }}">{{ translate('refer_&_earn') }}</a>
                                                @else
                                                    <a href="javascript:"
                                                        class="customer_login_register_modal">{{ translate('refer_&_earn') }}</a>
                                                @endif
                                            </li>
                                        @endif
                                ...
                                <div class="footer-widget ">
                                    ...
                                    <ul class="links">
                                        ...
                                        <li>
                                            <a href="{{ route('shop.apply') }}">{{ translate('sell_on') }}
                                                {{ $web_config['name']->value }}</a>
                                        </li>
                                ...
                                <div class="footer-widget">
                                    ...
                                    <ul class="links">
                                        <li>
                                            @if (auth('customer')->check())
                                                <a
                                                    href="{{ route('chat', ['type' => 'seller']) }}">{{ translate('live_chat') }}</a>
                                            @else
                                                <a href="javascript:"
                                                    class="customer_login_register_modal">{{ translate('live_chat') }}</a>
                                            @endif
                                        </li>
                                        <li>
                                            @if (auth('customer')->check())
                                            ...
                                            @else
                                                <a href="javascript:"
                                                    class="customer_login_register_modal">{{ translate('support_ticket') }}</a>
                                            @endif
                                        </li>
                                        <li>
                                            <a
                    ...
                    <div class="col-lg-6">
                        ...
                        <ul class="tags">
                            ...
                            @foreach ($web_config['tags'] as $item)
                                <li>
                                    <a
                                        href="{{ route('products') }}?search_category_value=all&name={{ str_replace(' ', '+', trim($item->tag)) }}&data_from=search&page=1">{{ $item->tag }}</a>
                                </li>
                            @endforeach
                                ...
                                <div class="app-btns">
                                    @if ($web_config['android']['status'])
                                        <a href="{{ $web_config['android']['link'] }}">
                                            <img loading="lazy"
                                                src="{{ theme_asset('assets/img/app-btn/google.png') }}"
                                    ...
                                    @if ($web_config['ios']['status'])
                                        <a href="{{ $web_config['ios']['link'] }}">
                                            <img loading="lazy"
                                                src="{{ theme_asset('assets/img/app-btn/apple.png') }}"
                                                alt="{{ translate('apple') }}">
                                        </a>
                                    @endif
                                </div>
            ...
            <div class="container">
                <div class="d-flex justify-content-evenly gap-4 justify-content-md-between flex-wrap">
                    ...
                    <ul class="links d-flex flex-wrap justify-content-center me-md-auto column-gap-4 row-gap-1">
                        <li>
                            <a href="{{ route('terms') }}"
                                class="text-white">{{ translate('terms_&_conditions') }}</a>
                        </li>
                        <li>
                            <a href="{{ route('privacy-policy') }}"
                                class="text-white">{{ translate('privacy_policy') }}</a>
                        </li>
                    </ul>
