    ...
    <div class="container">
        ...
        <div class="tab-content">
                ...
                <div class="address-details px-md-4">
                    <h4 class="subtitle mb-3 mx-2 text-capitalize">{{ translate('My_Childeren') }}</h4>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="child_list">
                                <table class="table-responsive table-borderless">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><img class="rounded-circle me-2" style="width: 20%" src="{{asset('public/assets/images/customers/child/'.$child->profile_picture)}}"></td>
                                            <td>{{ $child->name }}</td>
                                            <td>{{ $formattedAge }}</td>
                                            <td><a href="{{ route('my-child.destroy', $child->id) }}"><button type="button" class="btn btn-danger btn-sm">Delete</button></a></td>
                                        </tr>
                                    </tbody>
                                    @endforeach
                                </table>
