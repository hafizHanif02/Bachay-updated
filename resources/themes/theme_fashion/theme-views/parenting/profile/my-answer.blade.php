        ...
        <ul class="nav nav-tabs nav--tabs-3 justify-content-start mb-0 d-none d-md-flex">
            <li class="nav-item">
                <a href="{{ route('parenting-profile') }}"
                    class="nav-link {{ Request::is('parenting-profile') || Request::is('parenting-profile') || Request::is('parenting-question') ? 'active' : '' }}">Overview
                </a>
            </li>
            <li class="nav-item">
        ...
        <div class="container">
            ...
            @if (empty($myanswers))
                <div class="ask-question text-center mt-5">
                    ...
                    <p class="font-poppins mb-2">Parents like you are looking for help on their parenting problems. Your
                        answers
                        and experiences would be invaluable for them. View the Community Home Page and share your answers.
                    </p>
                            ...
                            <div class="d-flex gap-3">
                                <span>
                                    <img class="rounded-circle"
                                        src="{{ asset('storage/app/public/profile/' . $answer->user->image) }}"
                        ...
                        <div class="answer-parent-container d-flex justify-content-between mt-3">
                            ...
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end p-0">
                                    <li><a class="dropdown-item ps-3" href="#" style="font-size: 12px;">Report
                                            Abuse</a>
                                    </li>
                                </ul>
                            </div>
