            ...
            <div class="card-body py-5 px-lg-5">
                <div class="row align-items-center pb-5">
                    ...
                    <div class="col-lg-6 text-center">
                        ...
                        <form action="{{ route('customer.auth.login_submit') }}" class="otp-form" method="POST">
                            @csrf
                            <input type="hidden" name="user_id" value="{{ $user['email'] }}">
                            <div class="d-flex gap-2 gap-sm-3 align-items-end justify-content-center">
                                <input class="otp-field" type="number" name="opt-field[]" maxlength="1"
                                    autocomplete="off">
                                <input class="otp-field" type="number" name="opt-field[]" maxlength="1"
                                    autocomplete="off">
                                <input class="otp-field" type="number" name="opt-field[]" maxlength="1"
                            ...
                            <div class="d-flex justify-content-center gap-3 mt-5">
                                <button type="button" data-field = 'identity'
                                    data-route="{{ route('customer.auth.resend-otp-reset-password') }}"
                                    class="btn btn-outline-primary resend-otp-button" id="resend-otp">
