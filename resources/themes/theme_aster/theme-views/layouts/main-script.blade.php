...
<script>
    ...
    $(document).on('click', '#cookie-accept', function () {
        document.cookie = 'bachay_cookie_consent=accepted; max-age=' + 60 * 60 * 24 * 30;
        cookieSection.hide();
    });
    $(document).on('click', '#cookie-reject', function () {
        document.cookie = 'bachay_cookie_consent=reject; max-age=' + 60 * 60 * 24;
        cookieSection.hide();
    });

    $(document).ready(function () {
        if (document.cookie.indexOf("bachay_cookie_consent=accepted") !== -1) {
            cookieSection.hide();
        } else {
