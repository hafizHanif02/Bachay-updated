                                        ...
                                        <div class="col-md-10">
                                            <div class="d-m-flex align-items-center gap-3">
                                                ...
                                                <div class="d-flex justify-content-center align-items-center share-on-social">
                                                    @php
                                                        $text = "Greetings,bachay is the best e-commerce platform in the country.If you are new to this website dont forget to use " . $customer_detail->referral_code . " " ."as the referral code while sign up into bachay.";
                                                        $link = url('/');
                                                    @endphp
